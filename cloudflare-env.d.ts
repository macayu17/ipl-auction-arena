/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 777c04f331fe7e06a17d6309af8b63c9)
...
declare namespace Cloudflare {
	interface Env {
		...
		AUCTION_ADMIN_EMAIL: string;
		AUCTION_ADMIN_PASSWORD: string;
		TEAM_EMAIL_DOMAIN: string;
		TEAM_PASSWORD_PREFIX: string;
		UPSTASH_REDIS_REST_URL: string;
		UPSTASH_REDIS_REST_TOKEN: string;
		AUCTION_JWT_SECRET: string;
		PLAYER_IMAGE_BASE_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "SUPABASE_PROJECT_REF" | "AUCTION_ADMIN_EMAIL" | "AUCTION_ADMIN_PASSWORD" | "TEAM_EMAIL_DOMAIN" | "TEAM_PASSWORD_PREFIX" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "AUCTION_JWT_SECRET" | "PLAYER_IMAGE_BASE_URL">> {}
}
