  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="mt-0.5 shrink-0 rounded-lg border border-emerald-300/20 bg-black/20 p-1.5">
          {notification.teamCode ? (
            <TeamLogo shortCode={notification.teamCode} size={24} />
          ) : (
            <div className="h-6 w-6 rounded-full bg-emerald-300/30" />
          )}
        </div>
