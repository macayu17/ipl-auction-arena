...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col relative">
      {/* PillNav Container */}
      <div className="w-full flex justify-start pl-3 lg:pl-8 sticky top-0 z-[100] bg-transparent pointer-events-none pt-3 lg:pt-4 pb-2">
      ...
      <div className="flex-1 w-full px-2.5 pb-12 pt-4 lg:px-6 lg:pt-10 lg:pb-16">
        <div className="mx-auto max-w-[1800px] space-y-2 lg:space-y-3">
          ...
          <main className="space-y-2 lg:space-y-3">{children}</main>
        </div>
      </div>
    </div>
  );
